...
let s:colors = {
      ...
      \ "black": get(s:overrides, "black", { "gui": "#282C34", "cterm": "256", "cterm16": "0" }),
      ...
      \ "visual_grey": get(s:overrides, "visual_grey", { "gui": "#000000", "cterm": "255", "cterm16": "15" }),
      \ "menu_grey": get(s:overrides, "menu_grey", { "gui": "#3E4452", "cterm": "237", "cterm16": "8" }),
      \ "special_grey": get(s:overrides, "special_grey", { "gui": "#000000", "cterm": "238", "cterm16": "15" }),
